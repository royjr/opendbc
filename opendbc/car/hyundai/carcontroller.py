  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.CP.flags & HyundaiFlags.CANFD:
      ...
      if self.frame % 5 == 0 and (not hda2 or hda2_long) and self.car_fingerprint in (CAR.HYUNDAI_SONATA_HEV_2024,):
        can_sends.append(hyundaicanfd.create_msg_161(self.packer, self.CAN, CC.enabled, CS.msg_161, self.CP, hud_control, CS, CC, self.frame, CS.msg_1B5))
        can_sends.append(hyundaicanfd.create_msg_162(self.packer, self.CAN, CC.enabled, CS.msg_162, self.CP, hud_control, CS.msg_1B5, CC))
